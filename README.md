...
#Obs_matrix_all_new_20250711.csv is the capture history matrix for the project
#The observation matrix also includes the grouping and individual-level covariates (e.g., Fork Length, Weight; for GroupedModel_GitHub.R)
